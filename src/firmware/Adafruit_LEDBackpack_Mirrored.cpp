...
static const uint8_t numbertable_mirrored_zerooff[] = {
...
void Adafruit_7segment_Mirrored::writeDigitNumMirroredNoZero(uint8_t d, uint8_t num) {
  displaybuffer[d] = numbertable_mirrored_zerooff[num];
}
